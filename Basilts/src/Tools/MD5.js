...
or link back to this website, you can use any of the content published on this
website free of charge for any use: commercial or noncommercial. However, under
the license they are released through there are limitations to what you may or may not do.
...
You Can:
    ...
    * Share the resources with others, under the following terms:
        ...
        * Use an excerpt from the webpage if necessary (don’t copy the full article and
...
You Can Not:
    ...
    * You can NOT copy the full webpage and display it on your own website.
        (Use an excerpt by all means, but please link to the original resource
        download page – not the actual file.)
*/
